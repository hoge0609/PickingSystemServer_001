...
/**
 * Validate for 部品在庫テーブル; InnoDB free: 0 kB
 *
 * @param array $queries
 *
 * @return array
 */
function validate_t_parts_inventory($queries)
{
    $messages = array();
    ...
    // 部品数
    if (isset($queries['parts_inventory_count'])) {
        if ($queries['parts_inventory_count'] === '') {
...
/**
 * Default for 部品在庫テーブル; InnoDB free: 0 kB
 *
 * @return array
 */
function default_t_parts_inventory()
{
    return array(
        'parts_id'              => 0,
        'parts_inventory_count' => 0,
        'delete_flag'           => 0,
        'created_by'            => 0,
        'create_at'             => null,
        'updated_by'            => 0,
