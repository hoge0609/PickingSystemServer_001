<?php import('app/views/header.php') ?>
        ...
        <form action="<?php t(MAIN_FILE) ?>/m_product/post" method="post">
            <fieldset>
                <legend>製品マスタ; InnoDB free: 0 kB</legend>
                <dl>
                    <dt>製品ID(required)</dt>
                        <dd><input type="text" name="product_id" size="10" value="<?php t($_view['data']['product_id']) ?>"></dd>
                    <dt>製品名(required)</dt>
                        <dd><input type="text" name="product_name" size="30" value="<?php t($_view['data']['product_name']) ?>"></dd>
