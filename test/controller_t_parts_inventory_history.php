...
// index
{
    ...
    // test
    $_params = array('t_parts_inventory_history', 'index');
    controller('t_parts_inventory_history/index.php');
...
{
    // test
    $_params = array('t_parts_inventory_history', 'post');
    $_GET['id'] = 3;
    controller('t_parts_inventory_history/post.php');
    $html = view('t_parts_inventory_history/post.php', true);

    test_contains('t_parts_inventory_history/post', $html, 'value="' . $insert_t_parts_inventory_history[3]['id'] . '"');
}
